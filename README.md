...
- **Portfolio Optimization**: Mean-variance optimization with ESG preference term and constraints
...
- **Optimization**: Mean-variance objective with an ESG reward term: `mu @ w - lambda * w^T Σ w + gamma * ESG @ w`
